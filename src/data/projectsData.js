...
export const projectsData = [
  ...
  },
  {
    ...
    logo: '/assets/projects/hit-metaverse-logo.png',
    details: {
      images: ['/assets/projects/hit-metaverse-logo.png'],
  ...
  },
  {
    ...
    icon: 'campaign',
    accentColor: 'var(--google-blue)',
    logo: '/assets/projects/effector-logo.png',
    details: {
  ...
  },
  {
    ...
    details: {
      ...
      background: '当時、「メタバース」という言葉はバズワードとして広まりつつあったものの、各大学にメタバースを主目的に活動する公認サークルは少なく、立ち上がってもメンバーが少人数で持続的な運営に苦戦する団体が全国に散見されました。\n自大学で「HIT Metaverse」をゼロから立ち上げた経験から、「全国的なリソース共有と互助の基盤があれば、1つのサークルでは成し得ない規模のイベントや知見の集積ができるはずだ」という強い問題意識を抱き、北海道大学メタバース研究会と共に全国規模の連合組織の共同設立を決意しました。',
      flow: [
        '北海道大学メタバース研究会の設立代表・瑠奈氏と意気投合し、全国のXRサークルの互助・知見集積を目的とした連盟構想を策定',
        '「全国大学メタバースサークル連盟」を共同設立し、Discordやオンライン交流会を中心としたコミュニティ基盤を整備',
        '全国約10大学・約30名の学生を巻き込み、定例会やサークル運営ノウハウの共有基盤を確立',
        '組織立ち上げの基盤を強固にした後、次世代の意欲的なリーダーたちへバトンを引き継ぎ'
      ],
      impressions: '【大学の枠を越えた全国ネットワークの構築】\n異なる大学の学生リーダーと協働し、何もないゼロの状態から全国規模のコミュニティを立ち上げる推進力を培うことができました。1つの大学に閉じることなく、共通の目標を持つ全国の仲間を巻き込んで形にする経験は、その後の活動における大きな原動力となっています。',
      future: '【全日本大学メタバース連盟（NUMA）への発展と自走】\n設立時の志は次世代へと受け継がれ、現在は「全日本大学メタバース連盟（NUMA）」として全国20団体が加盟する一大アライアンスへと発展。\n毎月の定例会をはじめ、サークル横断のLT会やハッカソン企画、コミックマーケットへの出展など、学生主体のXR・メタバースシーンを牽引する組織として力強く自走・継続しています。\nゼロから立ち上げた互助の基盤が、今も全国の学生たちの挑戦を支え続けていることは大きな誇りです。',
      links: [
        { url: 'https://numa-meta.com/', title: '全日本大学メタバース連盟（NUMA）公式HP' },
        { url: 'https://numa-meta.com/members', title: '加盟団体一覧（全国20団体）' }
      ]
    }
  }
];
